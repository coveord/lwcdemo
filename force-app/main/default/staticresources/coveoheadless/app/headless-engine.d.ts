...
export interface Engine<State = SearchPageState> {
     ...
     */
    dispatch: ThunkDispatch<unknown, null, AnyAction> & ThunkDispatch<unknown, undefined, AnyAction> & Dispatch<AnyAction>;
    /**
...
export declare class HeadlessEngine<Reducers extends ReducersMapObject> implements Engine<StateFromReducersMapObject<Reducers>> {
    ...
    get dispatch(): ThunkDispatch<any, null, AnyAction> & Dispatch<AnyAction>;
